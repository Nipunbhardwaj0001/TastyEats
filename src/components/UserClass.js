...
class UserClass extends React.Component {
  ...
  async componentDidMount() {
    try {
      const data = await fetch("https://api.github.com/users/Nipunbhardwaj0001");
    ...
    return (
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden max-w-2xl mx-auto">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/3 bg-gradient-to-b from-orange-400 to-yellow-400 p-6 flex flex-col items-center justify-center">
            <img
              src={avatar_url}
              alt={name}
